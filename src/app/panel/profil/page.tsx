...
export default function ClinicProfilePage(): JSX.Element {
  ...
  const normalizedInstagram = useMemo<string>(
    () => normalizeInstagramInput(instagramInput),
    [instagramInput],
  );
  ...
  const saveProfile = useCallback(async (): Promise<void> => {
    ...
    try {
      ...
      setInstagramInput(data.clinic.instagramUrl ?? "");
  ...
  /*
   * İlk sayfa açılışında profil yüklenir.
   *
   * React'in set-state-in-effect kuralına takılmaması için effect içinde
   * senkron olarak loadProfile çağırmak yerine istek doğrudan başlatılır.
   * State güncellemeleri ağ isteği tamamlandıktan sonra yapılır.
   */
  useEffect(() => {
    let cancelled = false;
      ...
      <div className={styles.topBar}>
        <div>
          ...
          <div className={styles.sub}>
            Klinik dizininde daha güven veren bir profil için bilgilerini
            güncelle.
          </div>
        </div>
                ...
                <div className={styles.formGrid}>
                  ...
                  <div className={styles.field}>
                    ...
                    <div className={styles.badgeRow}>
                      {normalizedInstagram ? (
                        <a
                          className={`${styles.badge} ${styles.badgeIg}`}
                      ...
                      <div className={styles.help}>
                        Sadece kullanıcı adı yazarsan otomatik
                        linke çevirir.
                      </div>
                    </div>
                  </div>
        ...
        <aside className={styles.card}>
          <div className={styles.cardInner}>
            ...
            <div className={styles.sideSub}>
              Daha çok güven → daha çok dönüş
            </div>

            <div className={styles.progressTop}>
              <div className={styles.percentPill}>
                ⭐ {completion}%
              </div>
            ...
            <div className={styles.tip}>
              ...
              <div className={styles.tipText}>
                Instagram eklemek dizinde profili daha
                “güven veren” gösterir. Telefon doğru olursa
                dönüş hızı artar.
              </div>
            </div>
          </div>
