...
-- FK: Lead tablosu sende "Lead" (BÜYÜK L) ✅
ALTER TABLE `lead_distribution_logs`
  ADD CONSTRAINT `lead_distribution_logs_leadId_fkey`
  FOREIGN KEY (`leadId`) REFERENCES `Lead`(`id`)
  ON DELETE CASCADE ON UPDATE CASCADE;

-- FK: Klinik tablosu sende "clinics" ✅
ALTER TABLE `lead_distribution_logs`
  ADD CONSTRAINT `lead_distribution_logs_clinicId_fkey`
